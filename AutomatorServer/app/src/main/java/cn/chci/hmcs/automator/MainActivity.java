...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Settings.Secure.putString(getContentResolver(), Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES, "cn.chci.hmcs.automator/.MyAccessibilityService");
...
//        setAccessibility(getApplicationContext());
        ...
        if (!MyAccessibilityService.isServiceON(getApplicationContext(), MyAccessibilityService.class.getName())) {
